...
class Dmass {
public:
	Dmass(std::vector<std::pair<double, double>> &vect_Dmass, TH2D **hcorr, double minx,
		  double maxx, double miny, double maxy, bool sign = true);
	~Dmass();
	void SetExternal(double xx[ncontr][nprm], double dxx[ncontr][nprm],
					 double yy[nsigBu + nBs + nB0D + nBuD], double dyy[nsigBu + nBs + nB0D + nBuD]);
	...
	double minx, miny, maxx, maxy, xx[ncontr][nprm], dxx[ncontr][nprm],
		yy[nsigBu + nBs + nB0D + nBuD], dyy[nsigBu + nBs + nB0D + nBuD];
	// kde_fit kde_graphs;
	mb_2misspt_fit *mb_2misspt_graphs;
};
class Dmass_autofit : public Dmass {
public:
	Dmass_autofit(std::vector<std::pair<double, double>> vect_Dmass_, TH2D **hcorr_, double minx_,
				  double maxx_, double miny_, double maxy_);
	~Dmass_autofit() {};
	double operator()(double *x, double *par);
};
class Dmass_genExpo : public Dmass {
public:
	Dmass_genExpo(std::vector<std::pair<double, double>> vect_Dmass_, TH2D **hcorr_, double minx_,
				  double maxx_, double miny_, double maxy_);
	~Dmass_genExpo() {};
	double operator()(double *x, double *par);
};
...
public:
	Dmass_genCheb(std::vector<std::pair<double, double>> vect_Dmass_, TH2D **hcorr_, double minx_,
				  double maxx_, double miny_, double maxy_);
	~Dmass_genCheb() {};
	double operator()(double *x, double *par);
};
...
public:
	Dmass_genGaus(std::vector<std::pair<double, double>> vect_Dmass_, TH2D **hcorr_, double minx_,
				  double maxx_, double miny_, double maxy_);
	~Dmass_genGaus() {};
	double operator()(double *x, double *par);
};
...
public:
	Dmass_genGausD(std::vector<std::pair<double, double>> vect_Dmass_, TH2D **hcorr_, double minx_,
				   double maxx_, double miny_, double maxy_);
	~Dmass_genGausD() {};
	double operator()(double *x, double *par);
};
...
public:
	Dmass_genD0B(std::vector<std::pair<double, double>> vect_Dmass_, TH2D **hcorr_, double minx_,
				 double maxx_, double miny_, double maxy_);
	~Dmass_genD0B() {};
	double operator()(double *x, double *par);
};
...
public:
	Dmass_genDuB(std::vector<std::pair<double, double>> vect_Dmass_, TH2D **hcorr_, double minx_,
				 double maxx_, double miny_, double maxy_);
	~Dmass_genDuB() {};
	double operator()(double *x, double *par);
};
...
public:
	Dmass_genGaus2(std::vector<std::pair<double, double>> vect_Dmass_, TH2D **hcorr_, double minx_,
				   double maxx_, double miny_, double maxy_);
	~Dmass_genGaus2() {};
	double operator()(double *x, double *par);
};
...
public:
	Dmass_genCB2(std::vector<std::pair<double, double>> vect_Dmass_, TH2D **hcorr_, double minx_,
				 double maxx_, double miny_, double maxy_);
	~Dmass_genCB2() {};
	double operator()(double *x, double *par);
};
